...
export default class extends RootRoutes {
    ...
    routes: any[] = [
        ...
        //     name: "生活笔记",
        //     path: "/note",
        //     component: this.Loadable(() => import('./containers/count').then(x => x.Notepage)),
        // },
        // {
        //     name: "技术杂谈",
        //     path: "/chat",
        //     component: this.Loadable(() => import('./containers/count').then(x => x.Chatpage)),
        // },
        // {
        //     name: "登录",
        //     path: "/back/login",
        //     component: this.Loadable(() => import('./containers/count').then(x => x.Login)),
        // },
        {
            name: "生活笔记",
            path: "/note",
            component: this.Loadable(() => import('./containers/count').then(x => x. {
                name: "生活笔记",
                path: "/note",
                component: this.Loadable(() => import('./containers/count').then(x => x.Notepage)),
            },

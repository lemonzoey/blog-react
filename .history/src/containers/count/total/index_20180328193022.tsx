...
export class Layout extends React.Component<any, any> {
    Page(props){
     ...
     render(){
         let pathname = this.props.location.pathname=='/chat'?  <Chat/> : <LeftModuleBody/> 
       return <LayoutPublic>   
                    {this.props.location.pathname=='/'? <LeftModuleBody/>  : (this.props.location.pathname=='/note'?<Note/>:<Chat/>)  }
             </LayoutPublic> 
      }
